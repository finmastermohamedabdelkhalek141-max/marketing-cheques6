[index_23.html](https://github.com/user-attachments/files/30456624/index_23.html)
<!DOCTYPE html>
<html lang="ar" dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>إدارة شيكات العملاء — قسم التسويق</title>
<style>
  :root{
    --ink:#1b2430;
    --ink-soft:#5b6572;
    ...
    --due-soft:#fbf3d9;
    --radius:10px;
    --shadow:0 1px 2px rgba(27,36,48,.06), 0 6px 20px -10px rgba(27,36,48,.18);
    --serif:"Amiri","Traditional Arabic","Noto Naskh Arabic",Georgia,serif;
  ...
  *{box-sizing:border-box;}
  ...
  body{
    background:
      radial-gradient(1200px 500px at 15% -10%, #fffdf8 0%, transparent 60%),
      var(--paper);
    color:var(--ink);
  ...
  .sidebar{
    ...
    background:linear-gradient(180deg,var(--navy) 0%, #172c3a 100%);
    color:#eef3f5;
    padding:22px 16px;
  ...
  .brand small{
    ...
    color:#9fb3bf; margin-top:4px; letter-spacing:.5px;
  }
  .nav-item{
    display:flex; align-items:center; gap:10px;
    padding:11px 12px; border-radius:8px;
    color:#cfdde3; text-decoration:none; cursor:pointer;
  ...
  .nav-item.active{
    background:rgba(169,119,60,.22);
    color:#fff;
    border-color:rgba(169,119,60,.4);
  }
  .nav-item .dot{
  ...
  .nav-item-gold{
    background:linear-gradient(90deg, rgba(169,119,60,.20), rgba(169,119,60,.05));
    border:1px solid rgba(212,168,101,.45);
    color:#f4e6c9; font-weight:700; letter-spacing:.2px;
  }
  .nav-item-gold:hover{
    background:linear-gradient(90deg, rgba(169,119,60,.32), rgba(169,119,60,.08));
    color:#fff;
  }
  .nav-item-gold.active{
    background:linear-gradient(90deg, rgba(212,168,101,.4), rgba(212,168,101,.12));
    border-color:#d4a865; color:#fff;
  }
  .nav-seal{ font-size:15px; color:#d4a865; flex:none; }
  .nav-group-label{
    font-size:11px; color:#7f95a1; letter-spacing:.6px;
    padding:14px 12px 4px; text-transform:uppercase;
  }
  .sidebar-foot{
    padding:12px 8px 0;
    font-size:11.5px; color:#7f95a1;
  ...
  .designer-card .avatar-ring{
    width:96px; height:96px; border-radius:50%;
    padding:3px;
    background:linear-gradient(135deg,#d4a865 0%, #a9773c 55%, #7c561f 100%);
    box-shadow:0 4px 14px -4px rgba(0,0,0,.5);
  }
  .designer-card .avatar-ring img{
    width:100%; height:100%; border-radius:50%;
    object-fit:cover; display:block;
    border:2px solid #172c3a;
  }
  .designer-card .d-name{
    font-family:var(--serif);
    font-size:14.5px; color:#f4e6c9; font-weight:700;
    letter-spacing:.2px; line-height:1.35;
  }
  .designer-card .d-title{
    font-size:11px; color:#9fb3bf;
    letter-spacing:.4px;
  }
  .designer-card .d-tag{
    margin-top:2px;
    font-size:10px; color:#d4a865;
    letter-spacing:.6px;
    display:flex; align-items:center; gap:5px;
  }
  .designer-card .d-tag::before, .designer-card .d-tag::after{
    content:""; height:1px; width:16px;
    background:rgba(212,168,101,.5);
  }
  .designer-card .d-phone{
    margin-top:4px;
    font-size:13px; color:#d4a865;
    font-weight:700;
    letter-spacing:.5px;
    direction:ltr;
  }
  ...
  .topbar h1{ font-family:var(--serif); font-size:22px; margin:0; font-weight:600; }
  ...
  .card h2{ font-family:var(--serif); font-size:18px; margin:0 0 4px; font-weight:600; }
  ...
  input, select, textarea{
    width:100%; padding:10px 12px; border:1px solid #d7d1c2;
    border-radius:8px; background:#fffefb; color:var(--ink);
    font-family:var(--sans); font-size:14px; outline:none;
    transition:border-color .12s, box-shadow .12s;
  }
  input:focus, select:focus, textarea:focus{
    border-color:var(--brass); box-shadow:0 0 0 3px rgba(169,119,60,.15);
  }
  .field{ margin-bottom:14px; }
  .phone-input-group{ display:flex; align-items:stretch; direction:ltr; }
  .phone-input-group .phone-cc{
    display:flex; align-items:center; justify-content:center;
    padding:0 10px; border:1px solid #d7d1c2; border-inline-end:none;
    border-radius:8px 0 0 8px; background:var(--brass-soft); color:var(--brass-dark);
    font-family:var(--sans); font-size:13.5px; font-weight:700; white-space:nowrap;
  }
  ...
  .btn{
    ...
    font-family:var(--sans); transition:transform .06s ease, filter .12s ease;
  }
  ...
  .btn-ghost{ background:transparent; border-color:#d7d1c2; color:var(--ink); }
  .btn-ghost:hover{ background:#f1ede2; }
  .btn-danger{ background:transparent; border-color:#e3b7a1; color:var(--warn); }
  ...
  .badge-idle{ background:#eee9dc; color:var(--ink-soft); }

  table{ width:100%; border-collapse:collapse; font-size:13.5px; }
  th, td{ padding:10px 12px; text-align:right; border:1.5px solid var(--line); }
  th{
    font-size:11.5px; color:var(--ink-soft); text-transform:uppercase;
    letter-spacing:.4px; font-weight:700; background:#fbf9f4;
    position:sticky; top:0;
  }
  tbody tr:hover{ background:#faf7ef; }
  .table-wrap{ overflow-x:auto; border:2px solid var(--line); border-radius:8px; }
  .table-total-words{
    margin-top:8px; padding:8px 14px; border:1px solid var(--line); border-radius:8px;
    background:var(--panel); font-size:12.5px; font-weight:700; color:var(--ink-soft); text-align:center;
  }
  ...
  .kpi .val{ font-family:var(--serif); font-size:24px; font-weight:700; }
  .kpi .val small{ font-size:13px; font-weight:500; color:var(--ink-soft); }
  ...
  .peer-toast{
    ...
    background:var(--navy); border:1px solid rgba(212,168,101,.5);
  }
  .peer-toast.show{ transform:translateX(-50%) translateY(6px); }

  .modal-bg{
    position:fixed; inset:0; background:rgba(20,26,32,.5);
    display:flex; align-items:center; justify-content:center; z-index:100;
    padding:20px;
  }
  .modal{
    background:var(--panel); border-radius:12px; max-width:480px; width:100%;
    padding:24px; box-shadow:0 20px 60px rgba(0,0,0,.3);
  }
  .modal h3{ font-family:var(--serif); margin:0 0 8px; font-size:18px; }
  ...
  .client-hit:hover{ background:#faf7ef; }
  .client-hit .code{ color:var(--brass-dark); font-weight:700; font-family:monospace; }
  .dropdown{
  ...
  .receipt-note{
    background:var(--brass-soft); border:1px solid #e3cfa4; border-radius:8px;
    padding:12px 14px; font-size:12.5px; color:#5c4623; line-height:1.7; margin-top:16px;
  }
  ...
  @media print{
    ...
    #printArea{ position:absolute; top:0; right:0; left:0; margin:0; padding:0; }
    ...
    .receipt-doc{ border:none !important; padding:0 !important; max-width:none !important; }
  ...
  /* ---------- Collection Receipt ("إيصال تحصيل") — premium certificate design ---------- */
  .tc-wrap{ max-width:740px; margin:0 auto; padding:8px; position:relative; }
  .tc-frame{
    position:relative; overflow:hidden;
    border:3px double var(--navy); border-radius:6px;
    padding:20px 26px 16px; background:#fffefb;
  }
  .tc-frame::before{
    content:""; position:absolute; inset:9px;
    border:1px solid var(--brass); border-radius:3px; pointer-events:none;
  }
  .tc-corner{ position:absolute; width:36px; height:36px; z-index:1; }
  .tc-corner.tl{ top:4px; right:4px; }
  .tc-corner.tr{ top:4px; left:4px; transform:scaleX(-1); }
  .tc-corner.bl{ bottom:4px; right:4px; transform:scaleY(-1); }
  .tc-corner.br{ bottom:4px; left:4px; transform:scale(-1,-1); }
  .tc-watermark{
    position:absolute; inset:0; display:flex; align-items:center; justify-content:center;
    font-family:var(--serif); font-size:58px; font-weight:800; color:var(--navy);
    opacity:.045; transform:rotate(-28deg); white-space:nowrap; pointer-events:none; z-index:0;
  }
  .tc-body{ position:relative; z-index:2; text-align:center; }
  .tc-paid{
    position:absolute; top:10px; left:10px; z-index:3;
    border:3px double var(--ok); color:var(--ok); border-radius:8px;
    padding:5px 12px; font-family:var(--sans); font-size:12px; font-weight:800;
    transform:rotate(-12deg); background:rgba(255,255,255,.88);
  }
  .tc-paid.tc-partial{ border-color:var(--warn); color:var(--warn); }
  .tc-logo{ max-width:130px; height:auto; margin:0 auto 6px; display:block; }
  .tc-ribbon{
    display:inline-block; margin:2px auto 4px;
    background:linear-gradient(135deg, var(--brass), var(--brass-dark));
    color:#fff; font-family:var(--sans); font-size:14px; font-weight:800;
    letter-spacing:.5px; padding:6px 26px; border-radius:3px;
    box-shadow:0 3px 10px rgba(124,86,31,.35);
  }
  .tc-table td.v.k-red{ color:var(--warn); font-weight:800; }
  .tc-co{ font-family:var(--sans); font-size:12px; font-weight:700; color:var(--ink-soft); margin-top:6px; }
  .tc-co-details{ font-family:var(--sans); font-size:12px; font-weight:700; color:var(--ink-soft); margin-top:3px; line-height:1.6; }
  .tc-refno{
    font-family:var(--sans); font-size:12px; font-weight:700; color:var(--ink-soft);
    margin-top:8px; border-top:1px solid var(--line); border-bottom:1px solid var(--line); padding:5px 0;
  }
  .tc-table{ width:100%; border-collapse:collapse; margin:12px 0; font-family:var(--sans); font-size:12px; font-weight:700; }
  .tc-table td{ border:1.5px solid #8a7c5c; padding:5px 10px; text-align:center; }
  .tc-table td.k{ background:var(--navy-soft); font-weight:800; width:27%; }
  .tc-table td.v{ background:#fffefb; }
  .tc-amount{
    margin:12px auto; max-width:540px; position:relative;
    border:2px solid var(--brass); border-radius:6px;
    background:linear-gradient(180deg, var(--brass-soft), #fff);
    padding:9px 18px;
  }
  .tc-amount .figure{ font-size:14px; font-weight:800; color:var(--brass-dark); }
  .tc-amount .words{ font-size:12px; font-weight:700; margin-top:5px; color:var(--ink); line-height:1.6; }
  .tc-clarify{
    margin-top:9px; padding:8px 14px; border:1px solid #b9d6c3;
    background:var(--ok-soft); font-family:var(--sans); font-size:12px; font-weight:700;
    color:#1f4a34; line-height:1.6; border-radius:6px;
  }
  .tc-foot{ display:flex; align-items:flex-end; justify-content:space-between; margin-top:16px; gap:16px; }
  .tc-sign{ flex:1; font-family:var(--sans); font-size:12px; font-weight:700; }
  .tc-sign .line{ border-top:1px solid var(--ink); padding-top:5px; color:var(--ink-soft); }
  .tc-seal{
    flex:none; width:68px; height:68px; border-radius:50%;
    border:2px solid var(--brass-dark); position:relative;
    display:flex; align-items:center; justify-content:center;
    font-family:var(--sans); font-size:9px; font-weight:800; color:var(--brass-dark);
    text-align:center; line-height:1.3; padding:4px;
  }
  .tc-seal::before{ content:""; position:absolute; inset:5px; border:1px dashed var(--brass-dark); border-radius:50%; }
  .tc-legal{
    margin-top:10px; padding:8px 14px; border:1px dashed var(--warn);
    background:var(--warn-soft); font-family:var(--sans); font-size:12px; font-weight:700;
    color:#6b2f10; line-height:1.6; border-radius:6px;
  }
  @media print{
    .tc-wrap{ page-break-inside:avoid; break-inside:avoid; }
  }
  .receipt-head{
    display:flex; flex-direction:column; align-items:center; text-align:center;
    border-bottom:2px solid var(--brass); padding-bottom:14px; margin-bottom:18px;
  }
  .receipt-head h2{ margin:0; font-size:14px; font-weight:800; }
  .receipt-head .co{ font-size:12px; font-weight:700; color:var(--ink-soft); font-family:var(--sans); margin-top:4px; }
  .receipt-logo{ display:block; max-width:230px; height:auto; margin:0 auto 10px; }
  .receipt-head .co-details{ font-size:12px; font-weight:700; color:var(--ink-soft); font-family:var(--sans); margin-top:6px; line-height:1.7; }
  .receipt-no{ text-align:center; font-family:var(--sans); font-size:12px; font-weight:700; color:var(--ink-soft); margin-top:10px; }
  .receipt-grid{ display:grid; grid-template-columns:1fr 1fr; gap:10px 24px; margin:18px 0; font-family:var(--sans); font-size:12px; text-align:center; }
  .receipt-grid .k{ color:var(--ink-soft); font-size:12px; font-weight:700; display:block; margin-bottom:2px; }
  .receipt-grid .v{ font-weight:800; font-size:12px; }
  .receipt-section-title{
    font-family:var(--serif); font-size:14px; font-weight:800; text-align:center;
    margin:22px 0 10px; color:var(--ink);
  }
  .receipt-table{ width:100%; border-collapse:collapse; margin:16px 0; font-family:var(--sans); font-size:12px; font-weight:700; }
  .receipt-table th, .receipt-table td{ border:2px solid #8a7c5c; padding:8px 10px; text-align:center; }
  .receipt-table th{ background:var(--navy-soft); font-size:14px; font-weight:800; }
  .receipt-total-block{
    display:flex; justify-content:space-between; align-items:center;
    margin:-8px 0 16px; padding:10px 16px; border:2px solid #8a7c5c; border-radius:6px;
    background:var(--navy-soft); font-family:var(--sans); font-size:13px; font-weight:800; color:var(--ink);
  }
  .receipt-total-block .num{ font-size:14px; }
  .receipt-total-words{
    margin:-10px 0 16px; padding:8px 12px; border:1px solid #8a7c5c; border-top:none;
    background:var(--navy-soft); font-family:var(--sans); font-size:12px; font-weight:700;
    color:var(--ink); line-height:1.6; text-align:center;
  }
  .receipt-sign{ display:flex; justify-content:space-between; margin-top:40px; font-family:var(--sans); font-size:12px; font-weight:700; }
  .receipt-sign .line{ border-top:1px solid var(--ink); width:180px; padding-top:6px; text-align:center; color:var(--ink-soft); }
  .legal-note{
    margin-top:22px; padding:12px 14px; border:1px dashed var(--warn);
    background:var(--warn-soft); font-family:var(--sans); font-size:12px; font-weight:700;
    color:#6b2f10; line-height:1.7; border-radius:6px; text-align:center;
  }

  /* ---------- Receipts Archive (prestigious) ---------- */
  .archive-hero{
    position:relative; overflow:hidden;
    background:linear-gradient(135deg, var(--navy) 0%, #16303f 55%, #10222d 100%);
    border:1px solid rgba(212,168,101,.35);
    border-radius:14px; padding:26px 28px; margin-bottom:18px;
    box-shadow:0 10px 30px -12px rgba(23,44,58,.5);
  }
  .archive-hero::before{
    content:"۞"; position:absolute; left:-10px; top:-24px;
    font-size:150px; color:rgba(212,168,101,.08); line-height:1;
  }
  .archive-hero-top{ display:flex; align-items:center; gap:12px; position:relative; z-index:1; }
  .archive-seal{
    width:44px; height:44px; border-radius:50%; flex:none;
    background:radial-gradient(circle at 30% 30%, #e8c98a, #a9773c 70%, #7c561f);
    display:flex; align-items:center; justify-content:center;
    font-size:20px; color:#2b1c08; box-shadow:0 2px 6px rgba(0,0,0,.35), inset 0 1px 2px rgba(255,255,255,.4);
  }
  .archive-hero h2{
    font-family:var(--serif); font-size:20px; margin:0; color:#fdf8ef; font-weight:700;
  }
  .archive-hero .tagline{ font-size:12.5px; color:#b9cdd6; margin-top:3px; }
  .archive-hero .legal-blurb{
    position:relative; z-index:1; font-size:12px; color:#a9bcc6; line-height:1.8;
    margin-top:16px; padding-top:14px; border-top:1px dashed rgba(212,168,101,.35);
  }
  .archive-kpis{ display:grid; grid-template-columns:repeat(3,1fr); gap:12px; margin-top:18px; position:relative; z-index:1; }
  @media (max-width:900px){ .archive-kpis{ grid-template-columns:1fr; } }
  .archive-kpi{
    background:rgba(255,255,255,.06); border:1px solid rgba(212,168,101,.28); border-radius:10px;
    padding:12px 15px;
  }
  .archive-kpi .lbl{ font-size:11.5px; color:#a9bcc6; margin-bottom:5px; }
  .archive-kpi .val{ font-family:var(--serif); font-size:19px; font-weight:700; color:#f4e6c9; }
  .archive-kpi .val small{ font-size:12px; color:#b9cdd6; font-weight:500; }

  .receipt-ledger{ display:flex; flex-direction:column; gap:12px; }
  .receipt-card{
    display:flex; align-items:center; gap:16px;
    background:var(--panel); border:1px solid var(--line); border-right:4px solid var(--brass);
    border-radius:10px; padding:15px 18px; box-shadow:var(--shadow);
    transition:transform .12s ease, box-shadow .12s ease;
  }
  .receipt-card:hover{ transform:translateY(-1px); box-shadow:0 4px 16px -6px rgba(27,36,48,.25); }
  .receipt-card .rc-seq{
    font-family:var(--serif); font-size:12.5px; color:var(--brass-dark); font-weight:700;
    background:var(--brass-soft); border:1px solid #e3cfa4; border-radius:8px;
    padding:8px 10px; text-align:center; flex:none; min-width:64px;
  }
  .receipt-card .rc-seq small{ display:block; font-size:9.5px; color:var(--ink-soft); font-weight:600; margin-top:2px; }
  .receipt-card .rc-main{ flex:1; min-width:0; }
  .receipt-card .rc-client{ font-weight:700; font-size:14.5px; color:var(--ink); }
  .receipt-card .rc-client .code{ font-family:monospace; color:var(--brass-dark); font-weight:700; font-size:12.5px; margin-inline-start:6px; }
  .receipt-card .rc-meta{ font-size:12.5px; color:var(--ink-soft); margin-top:3px; }
  .receipt-card .rc-amount{ text-align:center; flex:none; }
  .receipt-card .rc-amount .v{ font-family:var(--serif); font-weight:700; font-size:16.5px; color:var(--ink); }
  .receipt-card .rc-amount .k{ font-size:10.5px; color:var(--ink-soft); }
  .receipt-card .rc-actions{ flex:none; display:flex; gap:8px; }
  @media (max-width:760px){
    .receipt-card{ flex-wrap:wrap; }
    .receipt-card .rc-actions{ width:100%; }
    .receipt-card .rc-actions .btn{ flex:1; justify-content:center; }
  }

  .import-hint{ font-size:12px; color:var(--ink-soft); margin-top:6px; }
  .toolbar{ display:flex; gap:10px; flex-wrap:wrap; align-items:center; margin-bottom:16px; }

  /* ---- Client form: distinguished sections ---- */
  .form-section{
    border:1px solid var(--line); border-radius:10px; padding:18px 20px;
    margin-bottom:18px; background:#fffefb;
  }
  .form-section.emphasis-brass{ border-color:#e3cfa4; background:var(--brass-soft); }
  .form-section.emphasis-navy{ border-color:#c7d6dc; background:var(--navy-soft); }
  .form-section-title{
    font-family:var(--serif); font-size:15.5px; font-weight:700; margin:0 0 14px;
    display:flex; align-items:center; gap:9px; color:var(--ink);
  }
  .form-section-title .num{
    display:inline-flex; align-items:center; justify-content:center;
    width:22px;height:22px;border-radius:50%; background:var(--brass); color:#fff;
    font-size:12px; font-weight:700; font-family:var(--sans); flex:none;
  }
  .calc-row{
    display:flex; justify-content:space-between; align-items:center;
    padding:9px 2px; border-bottom:1px dashed #d7cfba; font-size:13.5px;
  }
  ...
  .totals-row{
    ...
    border-radius:8px; font-weight:700; margin-top:8px; font-size:14px;
  }
  .year-block{
    border:1px solid var(--line); border-radius:9px; padding:15px 17px;
    margin-bottom:12px; background:#fbf9f4;
  }
  .year-block h4{ margin:0 0 12px; font-family:var(--serif); font-size:14.5px; font-weight:700; }
  .phase-grid{ display:grid; grid-template-columns:repeat(3,1fr); gap:12px; margin-bottom:6px; }
  ...
  #loginGate{
    ...
    background:
      radial-gradient(1200px 500px at 15% -10%, rgba(255,253,248,.08) 0%, transparent 60%),
      linear-gradient(180deg,var(--navy) 0%, #172c3a 100%);
    display:flex; align-items:center; justify-content:center;
    padding:20px;
  }
  .login-card{
  ...
  .login-card .brand{
    ...
    border-bottom:none; margin-bottom:4px; padding:0;
  }
  .login-card .brand small{
    display:block; font-family:var(--sans); font-size:11.5px;
    color:var(--ink-soft); margin-top:5px;
  }
  .login-card .login-seal{
    font-size:30px; color:var(--brass); margin-bottom:6px;
  }
  .login-card form{ margin-top:22px; text-align:right; }
  .login-card label{ margin-bottom:6px; }
  .login-card input{ text-align:center; letter-spacing:.4px; }
  .login-card input#loginCode{ direction:ltr; }
  .login-card .field{ margin-bottom:14px; }
  .login-err{
    display:none; background:var(--warn-soft); color:var(--warn);
    border:1px solid #f0c8ae; border-radius:8px;
    padding:9px 10px; font-size:12.5px; margin-bottom:14px;
  }
  .login-err.show{ display:block; }
  .login-card .btn{ width:100%; justify-content:center; padding:11px 12px; font-size:14.5px; }
  .login-foot{
    margin-top:16px; font-size:11px; color:var(--ink-soft);
    padding-top:14px; border-top:1px solid var(--line);
  }
  body.gate-open{ overflow:hidden; }
  body.gate-open .shell{ display:none; }

  /* ---------- Permission-hidden elements ---------- */
  .perm-hidden{ display:none !important; }

  .user-badge{
    display:flex; align-items:center; gap:8px;
    font-size:12px; color:#cfdde3;
  ...
  .user-badge .role-pill{
    ...
    background:rgba(212,168,101,.25); color:#f4e6c9; font-weight:700;
    border:1px solid rgba(212,168,101,.4);
  }
  .user-badge .who{ flex:1; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
  .logout-link{
    cursor:pointer; color:#9fb3bf; font-size:11px;
    text-decoration:underline; flex:none;
  }
  .logout-link:hover{ color:#fff; }
</style>

<!-- Firebase (مزامنة البيانات المشتركة بين الموظفين) -->
<script src="https://www.gstatic.com/firebasejs/10.13.0/firebase-app-compat.js"></script>
<script src="https://www.gstatic.com/firebasejs/10.13.0/firebase-auth-compat.js"></script>
<script src="https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore-compat.js"></script>
<script>
  var firebaseConfig = {
    apiKey: "AIzaSyDNjGPvfn8f22s2rOXgOcwTNFy7CD4vIrc",
    authDomain: "marketing-cheques-da740.firebaseapp.com",
    databaseURL: "https://marketing-cheques-da740-default-rtdb.europe-west1.firebasedatabase.app",
    projectId: "marketing-cheques-da740",
    storageBucket: "marketing-cheques-da740.firebasestorage.app",
    messagingSenderId: "1028145707448",
    appId: "1:1028145707448:web:a1781d85c7ca31ad2d374d",
    measurementId: "G-CG1C47WJGM"
  };
...
<div id="loginGate" style="display: flex;">
  <div class="login-card">
    ...
    <div class="brand">قسم التسويق
      <small>إدارة شيكات وخطط سداد العملاء</small>
    </div>
    <form id="loginForm" autocomplete="off">
      <div class="login-err" id="loginErr">الكود أو الرقم السري غير صحيح.</div>
      <div class="field">
        <label>الكود</label>
        <input type="text" id="loginCode" placeholder="example@gmail.com" autocomplete="off">
      </div>
      <div class="field">
        <label>الرقم السري</label>
        <input type="password" id="loginPass" placeholder="••••••" autocomplete="off">
      </div>
      <button type="submit" class="btn btn-brass" id="loginSubmitBtn" data-label="دخول">دخول</button>
    </form>
    <div class="login-foot">البيانات محفوظة على خادم مشترك وتظهر لجميع الموظفين فور إدخالها.</div>
  </div>
</div>
...
<div class="shell">
  <aside class="sidebar">
    ...
    <div class="user-badge" id="userBadge">
      <span class="who" id="userBadgeWho">CFOM22@gmail.com</span>
      <span class="role-pill" id="userBadgeRole">موظف</span>
      <span class="logout-link" id="btnLogout">خروج</span>
    </div>
    <div class="nav-group-label perm-hidden" id="navGroupDocs">المستندات الرسمية</div>
    <a class="nav-item nav-item-gold perm-hidden" data-view="receipts" data-perm="receipts"><span class="nav-seal">۞</span> إيصالات استلام الشيكات</a>
    <div class="nav-group-label" id="navGroupOps">العمليات</div>
    <a class="nav-item active" data-view="cheques" data-perm="cheques"><span class="dot"></span> إدارة الشيكات</a>
    <a class="nav-item perm-hidden" data-view="collect" data-perm="collect"><span class="dot"></span> تحصيل الشيكات</a>
    <a class="nav-item perm-hidden" data-view="clients" data-perm="clients"><span class="dot"></span> العملاء وخطط السداد</a>
    <div class="nav-group-label perm-hidden" id="navGroupReports">التقارير</div>
    <a class="nav-item perm-hidden" data-view="reportCheques" data-perm="reportCheques"><span class="dot"></span> تقرير الشيكات</a>
    <a class="nav-item perm-hidden" data-view="reportClients" data-perm="reportClients"><span class="dot"></span> تقرير العملاء</a>
    <div class="nav-group-label perm-hidden" id="navGroupAdmin">الإدارة</div>
    <a class="nav-item perm-hidden" data-view="users" data-perm="users"><span class="dot"></span> إدارة المستخدمين</a>
    <div class="designer-card">
      <div class="avatar-ring">
        <img src="data:image/jpeg;base64," alt="محمد عبد الخالق بسيوني">
      </div>
      <div class="d-name">محمد عبد الخالق بسيوني</div>
      <div class="d-title">المدير المالي</div>
      <div class="d-tag">مصمم ومطور النظام</div>
      <div class="d-phone">94328559</div>
    </div>
    <div class="sidebar-foot">يعمل بالكامل على هذا الجهاز — لا يوجد اتصال بخادم خارجي.</div>
  </aside>

  <div class="main">
    <div class="topbar">
      <div>
        <h1 id="pageTitle">إدارة الشيكات</h1>
        <div class="sub" id="pageSub">ابحث عن العميل بالكود لعرض خطة السداد وتسجيل استلام شيك</div>
      </div>
      <div class="no-print" style="display:flex;gap:10px;">
        <button class="btn btn-ghost btn-sm" id="btnSeed">تحميل بيانات تجريبية</button>
      </div>
    </div>
  ...
  <div class="card">
    ...
    <div class="row" style="align-items:end;">
      <div class="field" style="margin-bottom:0;">
        ...
        <input id="chqCode" placeholder="مثال: CL-1001" value="500" autocomplete="off">
      </div>
      <div class="field" style="margin-bottom:0;">
  ...
  <div class="card">
    <div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;">
      <div>
        <h2 style="margin-bottom:8px;">محمود <span class="muted" style="font-weight:400;font-size:14px;">— 500</span></h2>
        <div class="tag-flex">
          <span class="tag">عع</span>
          <span class="tag">رقم العقد: 2122</span>
          <span class="tag">سعر الوحدة: ٢٦٬٥٠٠ ر.ع</span>
          <span class="tag">تاريخ التعاقد: ١٠ يوليو ٢٠٢٦</span>
        </div>
      </div>
    </div>
    <div class="kpi-grid" style="margin-top:18px;">
      <div class="kpi"><div class="lbl">إجمالي المستحق</div><div class="val">٢٦٬٤٩٧٫٨٨ <small>ر.ع</small></div></div>
      <div class="kpi"><div class="lbl">إجمالي المسدد (شيكات محصّلة فعليًا)</div><div class="val">٠ <small>ر.ع</small></div></div>
      <div class="kpi"><div class="lbl">المتبقي</div><div class="val">٢٦٬٤٩٧٫٨٨ <small>ر.ع</small></div></div>
      <div class="kpi"><div class="lbl">متأخر السداد</div><div class="val" style="color:var(--warn)">٥٬٣٠٠ <small>ر.ع</small></div></div>
    </div>
  </div>
  ...
  <div class="card">
    <div class="toolbar" style="margin-bottom:2px;">
      ...
      <button class="btn btn-ghost btn-sm no-print" id="btnPrintPlan" style="display: none;">طباعة جدول السداد</button>
    </div>
    ...
    <div class="table-wrap">
      <table id="planTable">
        <thead><tr>
          ...
          <th>القيمة المستحقة</th><th>المسدد</th><th>رقم الشيك</th><th>الحالة</th>
        </tr></thead>
        <tbody>
          <tr>
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_down"></td>
              <td class="num muted">2</td>
              <td>دفعة المقدم </td>
              <td class="muted">مقدم</td>
              <td class="num">١٠ يوليو ٢٠٢٦</td>
              <td class="num">٥٬٣٠٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-warn">متأخر</span></td>
              
            </tr><tr>
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m1"></td>
              <td class="num muted">3</td>
              <td>السنة الأولى — شهر 1 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يوليو ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              
            </tr><tr>
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m2"></td>
              <td class="num muted">4</td>
              <td>السنة الأولى — شهر 2 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أغسطس ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m3"></td>
              <td class="num muted">5</td>
              <td>السنة الأولى — شهر 3 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ سبتمبر ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m4"></td>
              <td class="num muted">6</td>
              <td>السنة الأولى — شهر 4 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أكتوبر ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m5"></td>
              <td class="num muted">7</td>
              <td>السنة الأولى — شهر 5 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ نوفمبر ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m6"></td>
              <td class="num muted">8</td>
              <td>السنة الأولى — شهر 6 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ ديسمبر ٢٠٢٦</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m7"></td>
              <td class="num muted">9</td>
              <td>السنة الأولى — شهر 7 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يناير ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m8"></td>
              <td class="num muted">10</td>
              <td>السنة الأولى — شهر 8 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٧ فبراير ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m9"></td>
              <td class="num muted">11</td>
              <td>السنة الأولى — شهر 9 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مارس ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m10"></td>
              <td class="num muted">12</td>
              <td>السنة الأولى — شهر 10 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أبريل ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m11"></td>
              <td class="num muted">13</td>
              <td>السنة الأولى — شهر 11 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مايو ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y1m12"></td>
              <td class="num muted">14</td>
              <td>السنة الأولى — شهر 12 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يونيو ٢٠٢٧</td>
              <td class="num">١٬٠١٥٫٩٦</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              
            </tr><tr>
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m1"></td>
              <td class="num muted">15</td>
              <td>السنة الثانية — شهر 1 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يوليو ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m2"></td>
              <td class="num muted">16</td>
              <td>السنة الثانية — شهر 2 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أغسطس ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m3"></td>
              <td class="num muted">17</td>
              <td>السنة الثانية — شهر 3 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ سبتمبر ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m4"></td>
              <td class="num muted">18</td>
              <td>السنة الثانية — شهر 4 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أكتوبر ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m5"></td>
              <td class="num muted">19</td>
              <td>السنة الثانية — شهر 5 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ نوفمبر ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m6"></td>
              <td class="num muted">20</td>
              <td>السنة الثانية — شهر 6 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ ديسمبر ٢٠٢٧</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m7"></td>
              <td class="num muted">21</td>
              <td>السنة الثانية — شهر 7 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يناير ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m8"></td>
              <td class="num muted">22</td>
              <td>السنة الثانية — شهر 8 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٨ فبراير ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m9"></td>
              <td class="num muted">23</td>
              <td>السنة الثانية — شهر 9 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مارس ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m10"></td>
              <td class="num muted">24</td>
              <td>السنة الثانية — شهر 10 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أبريل ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m11"></td>
              <td class="num muted">25</td>
              <td>السنة الثانية — شهر 11 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مايو ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y2m12"></td>
              <td class="num muted">26</td>
              <td>السنة الثانية — شهر 12 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يونيو ٢٠٢٨</td>
              <td class="num">١٬٠١٥٫٩٦</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m1"></td>
              <td class="num muted">27</td>
              <td>السنة الثالثة — شهر 1 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يوليو ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m2"></td>
              <td class="num muted">28</td>
              <td>السنة الثالثة — شهر 2 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أغسطس ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m3"></td>
              <td class="num muted">29</td>
              <td>السنة الثالثة — شهر 3 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ سبتمبر ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m4"></td>
              <td class="num muted">30</td>
              <td>السنة الثالثة — شهر 4 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أكتوبر ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m5"></td>
              <td class="num muted">31</td>
              <td>السنة الثالثة — شهر 5 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ نوفمبر ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m6"></td>
              <td class="num muted">32</td>
              <td>السنة الثالثة — شهر 6 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ ديسمبر ٢٠٢٨</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m7"></td>
              <td class="num muted">33</td>
              <td>السنة الثالثة — شهر 7 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يناير ٢٠٢٩</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m8"></td>
              <td class="num muted">34</td>
              <td>السنة الثالثة — شهر 8 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٧ فبراير ٢٠٢٩</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m9"></td>
              <td class="num muted">35</td>
              <td>السنة الثالثة — شهر 9 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مارس ٢٠٢٩</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m10"></td>
              <td class="num muted">36</td>
              <td>السنة الثالثة — شهر 10 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ أبريل ٢٠٢٩</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m11"></td>
              <td class="num muted">37</td>
              <td>السنة الثالثة — شهر 11 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ مايو ٢٠٢٩</td>
              <td class="num">٥٥٠</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
              ...
              <td class="no-print"><input type="checkbox" class="instCheck" data-inst="cl_htqhrpm_y3m12"></td>
              <td class="num muted">38</td>
              <td>السنة الثالثة — شهر 12 </td>
              <td class="muted">قسط شهري</td>
              <td class="num">٢٩ يونيو ٢٠٢٩</td>
              <td class="num">١٬٠١٥٫٩٦</td>
              <td class="num">٠ </td>
              <td class="num"><span class="muted">—</span></td>
              <td><span class="badge badge-idle">لم يحين موعدها</span></td>
  ...
  <div class="card">
    ...
    <div class="row3">
      ...
      <div class="field">
        ...
        <select id="chkBank"><option value="">— اختر —</option><option value="نقدًا (كاش)">نقدًا (كاش)</option><optgroup label="تحويل بنكي"><option value="تحويل - بنك مسقط">تحويل - بنك مسقط</option><option value="تحويل - البنك الوطني العماني">تحويل - البنك الوطني العماني</option><option value="تحويل - بنك ظفار">تحويل - بنك ظفار</option><option value="تحويل - بنك صحار الدولي">تحويل - بنك صحار الدولي</option><option value="تحويل - البنك العربي العماني">تحويل - البنك العربي العماني</option><option value="تحويل - البنك الأهلي">تحويل - البنك الأهلي</option><option value="تحويل - بنك نزوى">تحويل - بنك نزوى</option><option value="تحويل - بنك العز الإسلامي">تحويل - بنك العز الإسلامي</option><option value="تحويل - ميثاق (الخدمات المصرفية الإسلامية - بنك مسقط)">تحويل - ميثاق (الخدمات المصرفية الإسلامية - بنك مسقط)</option><option value="تحويل - بنك التنمية العماني">تحويل - بنك التنمية العماني</option><option value="تحويل - بنك الإسكان العماني">تحويل - بنك الإسكان العماني</option><option value="تحويل - HSBC عمان">تحويل - HSBC عمان</option><option value="تحويل - بنك أبوظبي الأول - عمان">تحويل - بنك أبوظبي الأول - عمان</option><option value="تحويل - بنك قطر الوطني - عمان">تحويل - بنك قطر الوطني - عمان</option><option value="تحويل - ستاندرد تشارترد - عمان">تحويل - ستاندرد تشارترد - عمان</option><option value="تحويل - ستيت بنك أوف إنديا - عمان">تحويل - ستيت بنك أوف إنديا - عمان</option><option value="تحويل - بنك حبيب المحدود - عمان">تحويل - بنك حبيب المحدود - عمان</option><option value="تحويل - بنك بيروت عمان">تحويل - بنك بيروت عمان</option></optgroup><optgroup label="بنوك محلية"><option value="بنك مسقط">بنك مسقط</option><option value="البنك الوطني العماني">البنك الوطني العماني</option><option value="بنك ظفار">بنك ظفار</option><option value="بنك صحار الدولي">بنك صحار الدولي</option><option value="البنك العربي العماني">البنك العربي العماني</option><option value="البنك الأهلي">البنك الأهلي</option></optgroup><optgroup label="بنوك إسلامية"><option value="بنك نزوى">بنك نزوى</option><option value="بنك العز الإسلامي">بنك العز الإسلامي</option><option value="ميثاق (الخدمات المصرفية الإسلامية - بنك مسقط)">ميثاق (الخدمات المصرفية الإسلامية - بنك مسقط)</option></optgroup><optgroup label="بنوك متخصصة"><option value="بنك التنمية العماني">بنك التنمية العماني</option><option value="بنك الإسكان العماني">بنك الإسكان العماني</option></optgroup><optgroup label="فروع بنوك أجنبية"><option value="HSBC عمان">HSBC عمان</option><option value="بنك أبوظبي الأول - عمان">بنك أبوظبي الأول - عمان</option><option value="بنك قطر الوطني - عمان">بنك قطر الوطني - عمان</option><option value="ستاندرد تشارترد - عمان">ستاندرد تشارترد - عمان</option><option value="ستيت بنك أوف إنديا - عمان">ستيت بنك أوف إنديا - عمان</option><option value="بنك حبيب المحدود - عمان">بنك حبيب المحدود - عمان</option><option value="بنك بيروت عمان">بنك بيروت عمان</option></optgroup><option value="__other__">بنك آخر (اكتب الاسم)</option></select>
    <input id="chkBankOther" placeholder="اكتب اسم البنك" style="margin-top:8px;display:none;" value="">
      </div>
      <div class="field">
    ...
    <div class="row">
      <div class="field">
        ...
        <input id="chkReceived" type="date" value="2026-07-24" readonly="" style="background:#f1ede2;">
    ...
    <div class="field">
      ...
      <input id="chkAmount" type="number" step="0.001" placeholder="0.00" readonly="" style="background:#f1ede2;">
  ...
  <div class="tc-wrap">
    <div class="tc-frame">
      ...
      <div class="tc-body">
        ...
        <div class="tc-refno">رقم مرجعي: TC-00028 &nbsp;|&nbsp; تاريخ الإصدار: ١٦ يوليو ٢٠٢٦</div>

        <table class="tc-table">
          <tbody><tr><td class="k">رقم إيصال التحصيل</td><td class="v" colspan="3">22</td></tr>
          <tr><td class="k">اسم العميل</td><td class="v">ممم</td><td class="k">كود العميل</td><td class="v">1</td></tr>
          <tr><td class="k">اسم الوحدة</td><td class="v">ححح</td><td class="k">رقم العقد</td><td class="v">2</td></tr>
          <tr><td class="k">البيان</td><td class="v k-red" colspan="3">السنة الأولى — شهر 2</td></tr>
          <tr><td class="k">رقم الدفعة التعاقدية</td><td class="v" colspan="3">2</td></tr>
          <tr><td class="k">تاريخ استحقاق الدفعة التعاقدية</td><td class="v">١٣ أغسطس ٢٠٢٦</td><td class="k">قيمة استحقاق الدفعة التعاقدية</td><td class="v">٧٬٥٠٠ ر.ع</td></tr>
          <tr><td class="k">تاريخ التحصيل الفعلي</td><td class="v">١٦ يوليو ٢٠٢٦</td><td class="k">طريقة التحصيل</td><td class="v">تحويل - بنك ظفار</td></tr>
        </tbody></table>

        <div class="tc-amount">
          <div class="figure">المبلغ المحصَّل: ٧٬١٠٠ ريال عماني</div>
          <div class="words">المبلغ كتابة: سبعة آلاف ومائة ريال عماني لا غير</div>
        </div>

        <div class="tc-clarify">
          <strong>توضيح محاسبي:</strong> يُثبت هذا الإيصال الرسمي أن العميل قد قام بسداد مبلغ وقدره (٧٬١٠٠ ريال عماني) بتاريخ ١٦ يوليو ٢٠٢٦، يمثل الجزء المتبقي والأخير من قيمة الدفعة التعاقدية رقم 2 البالغة قيمتها التعاقدية المستحقة (٧٬٥٠٠ ريال عماني)، وذلك استكمالًا لما سبق تحصيله من العميل ذاته بمبلغ (٤٠٠ ريال عماني) بموجب إيصال التحصيل السابق رقم (20) والمرجع الداخلي رقم (TC-00027)، والذي كان قد ترك رصيدًا متبقيًا ومستحقًا وقدره (٧٬١٠٠ ريال عماني) قبل صدور هذا الإيصال. وبإتمام تحصيل هذا المبلغ الأخير وقيده في السجلات المحاسبية للشركة، يصبح إجمالي ما تم تحصيله فعليًا من هذه الدفعة التعاقدية (٧٬٥٠٠ ريال عماني)، بما يُعادل كامل قيمتها الاسمية المستحقة ودون أي نقص، فلا يتبقى بذمة العميل أي مبلغ آخر عن هذه الدفعة تحديدًا وفقًا لشروط عقد البيع رقم 2. وبهذا تُعتبر الدفعة التعاقدية المذكورة مسددة ومُسوّاة بالكامل في السجلات المالية للشركة، وذلك دون أي أثر على باقي مستحقات العميل الأخرى غير المشمولة بهذا الإيصال.
        </div>
...
/* ============================= STORAGE ============================= */
const LS_KEY = "marketing_cheques_v1";
...
function loadState(){
  ...
  return { clients:[], cheques:[], nextClientSeq:1, nextChequeSeq:1 };
}
/* يضمن اكتمال الحقول الأساسية في state سواء بعد التحميل المحلي أو بعد وصول نسخة من السحابة */
function normalizeState(){
  if(!Array.isArray(state.clients)) state.clients = [];
  if(!Array.isArray(state.cheques)) state.cheques = [];
  if(!state.nextClientSeq) state.nextClientSeq = 1;
  if(!state.nextChequeSeq) state.nextChequeSeq = 1;
...
/* البيانات مخزَّنة كاملة كنص JSON واحد داخل مستند مشترك، بحيث أي بيانات يضيفها أي موظف
   تُحفظ فورًا على الخادم وتظهر تلقائيًا عند جميع الموظفين الآخرين دون إعادة تحميل الصفحة. */
function cloudDocRef(){
  return firebase.firestore().collection("sharedData").doc("state");
}
let cloudUnsub = null;
let cloudPushTimer = null;
function pushStateToCloud(){
  if(!(currentUser && firebase.auth().currentUser)) return;
  ...
  cloudPushTimer = setTimeout(function(){
    cloudDocRef().set({
      ...
      console.error(e);
      toast("تعذر حفظ البيانات على الخادم — تحقق من الاتصال بالإنترنت");
    });
  }, 350);
}
async function initCloudSync(){
  try{
    ...
    if(snap.exists && snap.data() && snap.data().json){
      ...
      // أول تشغيل: لا توجد بيانات على السحابة بعد — نرفع البيانات المحلية الحالية لتكون نقطة البداية المشتركة
    ...
    console.error(e);
    toast("تعذر الاتصال بالخادم السحابي — سيتم العمل بالبيانات المحفوظة على هذا الجهاز مؤقتًا");
  }
  normalizeState();
  localStorage.setItem(LS_KEY, JSON.stringify(state));

  if(cloudUnsub){ cloudUnsub(); cloudUnsub = null; }
  cloudUnsub = cloudDocRef().onSnapshot({includeMetadataChanges:true}, function(snap){
    if(snap.metadata.hasPendingWrites) return; // تجاهل الصدى الناتج عن كتابتنا نحن لتفادي إعادة رسم غير ضرورية
    const data = snap.data();
    if(!data || !data.json) return;
    try{
      const remote = JSON.parse(data.json);
      const cameFromSomeoneElse = data.updatedBy && currentUser && normCode(data.updatedBy)!==normCode(currentUser.code);
      const previous = state;
      state = remote;
      normalizeState();
      localStorage.setItem(LS_KEY, JSON.stringify(state));
      if(cameFromSomeoneElse){
        describeIncomingChanges(previous, state, data.updatedBy).forEach(showPeerNotify);
      }
...
const USERS = [
  ...
  },
  {
    ...
    label: "مسؤول",
    perms: ["cheques"],
    caps: { clientsMode:"none", chequesMode:"selectRegisterNoPrint", collectMode:"none" }
  },
  {
...
// CFO11 (الآن «مسؤول»): يرى كل الأعمدة والتفاصيل الكاملة في شاشة إدارة الشيكات، ومسموح له بتحديد
// الدفعة وتسجيل رقم الشيك واسم البنك، لكن غير مصرح له بالطباعة أو التعديل أو الحذف
function isSelectRegisterNoPrintRole(){
  return caps().chequesMode === "selectRegisterNoPrint";
}
...
// صلاحية الأدمن: التحكم الكامل في بنود خطط السداد (إضافة/حذف/ترتيب) للأقساط الاعتيادية والاستشاري
function isAdmin(){
...
function setLoginBusy(busy){
  ...
  if(btn){
    btn.disabled = !!busy;
    btn.textContent = busy ? "جارٍ التحقق..." : (btn.dataset.label || btn.textContent);
    if(!btn.dataset.label && !busy) btn.dataset.label = btn.textContent;
  }
}

async function doLogin(code, password){
  const errBox = document.getElementById("loginErr");
  const u = USERS.find(x=>normCode(x.code)===normCode(code));
  if(!u){
    if(errBox){ errBox.textContent = "الكود أو الرقم السري غير صحيح."; errBox.classList.add("show"); }
    return false;
  }
  ...
  setLoginBusy(true);
  try{
    await firebase.auth().signInWithEmailAndPassword(u.code, password);
    // onAuthStateChanged سيتولى استكمال الدخول وجلب البيانات ومزامنتها
    return true;
  }catch(err){
    console.error(err);
    setLoginBusy(false);
...
function doLogout(){
  ...
  // onAuthStateChanged سيتولى تفريغ currentUser وفتح شاشة الدخول
}
...
function initAuth(){
  ...
  firebase.auth().onAuthStateChanged(async function(fbUser){
    if(fbUser && fbUser.email){
      const u = USERS.find(x=>normCode(x.code)===normCode(fbUser.email));
      if(u && isUserActive(u.code)){
        currentUser = u;
        closeGate();
        ...
        // الحساب غير معرَّف في قائمة الصلاحيات أو موقوف — يُمنع من الدخول رغم صحة كلمة المرور
        currentUser = null;
...
/* Compute the date `months` after startDate, keeping startDate's day-of-month
   (e.g. 29/30/31) in every month that has it, and clamping to that month's
   last day when it doesn't (e.g. day 31 start -> Feb 28/29, Apr/Jun/Sep/Nov 30).
   Anchored to the original start day each time so short months don't drag
   later months down (unlike repeated setMonth() calls on a running cursor). */
function addMonthsAnchored(startDate, months){
  const day = startDate.getDate();
  const d = new Date(startDate.getFullYear(), startDate.getMonth()+months, 1);
  const lastDayOfTargetMonth = new Date(d.getFullYear(), d.getMonth()+1, 0).getDate();
  d.setDate(Math.min(day, lastDayOfTargetMonth));
  return d;
}
/* Format a Date as YYYY-MM-DD using its LOCAL year/month/day — unlike
   toISOString(), which converts to UTC first and can shift the date back
   by a day in timezones ahead of UTC (e.g. Oman, UTC+4). */
...
/* ============================= الأصوات (شاشات + أزرار) ============================= */
/* أصوات مُولَّدة برمجيًا (Web Audio API) — بدون ملفات خارجية، لكل نوع حدث نغمة مختلفة */
let audioCtx = null;
...
function playTone(freqs, opts){
  ...
  if(!ctx) return;
  const o = opts||{};
  const duration = o.duration||0.13, gap = o.gap==null?0.035:o.gap, type = o.type||"sine", volume = o.volume==null?0.15:o.volume;
...
const SOUNDS = {
  success: function(){ playTone([659,988], {duration:0.10, gap:0.03, type:"sine", volume:0.16}); },
  add:     function(){ playTone([523,784,1047], {duration:0.08, gap:0.02, type:"triangle", volume:0.14}); },
  warning: function(){ playTone([415], {duration:0.17, type:"square", volume:0.09}); },
  error:   function(){ playTone([311,220], {duration:0.16, gap:0.02, type:"sawtooth", volume:0.13}); },
  click:   function(){ playTone([740], {duration:0.045, type:"sine", volume:0.06}); },
  view:    function(){ playTone([494,659], {duration:0.09, gap:0.015, type:"sine", volume:0.10}); },
  incoming:function(){ playTone([784,988,1319], {duration:0.09, gap:0.02, type:"triangle", volume:0.13}); }
};
function classifySound(msg){
  const s = String(msg||"");
  if(/تعذر|غير صحيح|غير صالح/.test(s)) return "error";
  if(/لم يتم|لا توجد|أدخل|اختر|حدد|يجب أن/.test(s)) return "warning";
  if(/إضافة/.test(s)) return "add";
  if(/^تم |بنجاح/.test(s)) return "success";
  return "click";
}
function toast(msg){
  ...
  try{ (SOUNDS[classifySound(msg)]||SOUNDS.click)(); }catch(e){}
}
/* صوت نقر خفيف عند الضغط على أي زر أو عنصر تنقل، لتمييز التفاعل عن نتيجته */
document.addEventListener("click", function(e){
  const el = e.target.closest(".btn, .nav-item");
  if(el && !el.disabled) SOUNDS.click();
}, true);

/* ============================= إشعارات وصول تحديثات من موظفين آخرين ============================= */
/* شريط منفصل عن toast العادي (له صوت وطابور عرض خاص به) حتى لا يتعارض توقيته مع رسائل نتائج
   عمليات المستخدم نفسه على نفس الجهاز. */
let peerNotifyQueue = [];
let peerNotifyBusy = false;
function showPeerNotify(msg){
  peerNotifyQueue.push(msg);
  if(!peerNotifyBusy) drainPeerNotifyQueue();
}
function drainPeerNotifyQueue(){
  const msg = peerNotifyQueue.shift();
  if(msg===undefined){ peerNotifyBusy=false; return; }
  peerNotifyBusy = true;
  let el = document.getElementById("peerNotify");
  if(!el){
    el = document.createElement("div");
    el.id = "peerNotify";
    el.className = "toast peer-toast";
    document.body.appendChild(el);
  }
  el.textContent = msg;
  el.classList.add("show");
  try{ SOUNDS.incoming(); }catch(e){}
  setTimeout(function(){
    el.classList.remove("show");
    setTimeout(drainPeerNotifyQueue, 220);
  }, 2600);
}

const EMPLOYEE_LABELS = {}; // code(lowercase) -> اسم مختصر معروض في الإشعار، يُبنى تلقائيًا من USERS
function peerLabel(code){
  if(!code) return "أحد الموظفين";
  const key = normCode(code);
  if(EMPLOYEE_LABELS[key]) return EMPLOYEE_LABELS[key];
  const u = USERS.find(x=>normCode(x.code)===key);
  const short = String(code).split("@")[0];
  return u ? (u.label+" ("+short+")") : short;
}

/* يقارن نسخة قديمة وجديدة من state لتحديد ما الذي أُضيف تحديدًا (عميل/شيك/تحصيل)،
   لبناء رسالة إشعار مفهومة بدل مجرد "تم تحديث البيانات". */
function describeIncomingChanges(oldState, newState, byCode){
  const who = peerLabel(byCode);
  const msgs = [];
  try{
    const oldClientIds = new Set((oldState.clients||[]).map(c=>c.id));
    const newClients = (newState.clients||[]).filter(c=>!oldClientIds.has(c.id));
    newClients.forEach(c=> msgs.push(`${who} أضاف عميلًا جديدًا: ${c.name||c.code||""}`));

    const oldChequeIds = new Set((oldState.cheques||[]).map(c=>c.id));
    const newCheques = (newState.cheques||[]).filter(c=>!oldChequeIds.has(c.id));
    if(newCheques.length){
      const clientsById = {}; (newState.clients||[]).forEach(c=>clientsById[c.id]=c);
      newCheques.forEach(chq=>{
        const cl = clientsById[chq.clientId];
        msgs.push(`${who} أضاف شيكًا جديدًا${cl ? " للعميل "+(cl.name||cl.code) : ""}${chq.chequeNumber ? " (رقم "+chq.chequeNumber+")" : ""}`);
      });
    }

    const oldCollIds = new Set((oldState.collections||[]).map(r=>r.id));
    const newColls = (newState.collections||[]).filter(r=>!oldCollIds.has(r.id));
    if(newColls.length){
      const clientsById = {}; (newState.clients||[]).forEach(c=>clientsById[c.id]=c);
      newColls.forEach(rec=>{
        const cl = clientsById[rec.clientId];
        msgs.push(`${who} سجّل تحصيل مبلغ ${fmt(rec.amount)} ر.ع${cl ? " من العميل "+(cl.name||cl.code) : ""}`);
      });
    }

    // تغييرات على شيكات موجودة مسبقًا (تحصيل/ارتداد/تعديل حالة) دون إضافة سجلات جديدة
    if(!msgs.length){
      const oldById = {}; (oldState.cheques||[]).forEach(c=>oldById[c.id]=c);
      const changedStatus = (newState.cheques||[]).find(c=>{
        const prev = oldById[c.id];
        return prev && prev.status !== c.status;
      });
      if(changedStatus){
        const clientsById = {}; (newState.clients||[]).forEach(c=>clientsById[c.id]=c);
        const cl = clientsById[changedStatus.clientId];
        const statusLabel = changedStatus.status==="cleared" ? "تحصيل شيك" : changedStatus.status==="bounced" ? "ارتداد شيك" : "تحديث حالة شيك";
        msgs.push(`${who} سجّل ${statusLabel}${cl ? " للعميل "+(cl.name||cl.code) : ""}`);
      }
    }
  }catch(e){ console.error(e); }
  if(!msgs.length) msgs.push(`${who} حدّث البيانات`);
  return msgs;
}
function esc(s){
...
/* For a still-pending cheque, derive its collection urgency from its due date (chequeDate):
   ...
   - due date within the next 7 days (inclusive, but not yet passed): "في انتظار التحصيل"
   - due date more than 7 days away (or no due date set): "لم يحين موعدها" */
...
function chequeStatusBadge(chq){
  ...
  const urgencyMap = {
    ...
    waiting:    ['badge-due','في انتظار التحصيل'],
    upcoming:   ['badge-idle','لم يحين موعدها'],
  };
...
function buildPlan(client){
  ...
  if(client.installmentMode === "consultant"){
    ...
    for(let y=1; y<=client.years; y++){
      ...
      for(let m=1; m<=12; m++){
        const due = addMonthsAnchored(startDate, monthIndex);
        monthIndex++;
        let amt;
    ...
    // بنود إضافية على الأقساط الاعتيادية (يضيفها الأدمن) — تتحول لأقساط فعلية
    // تُضاف بعد جدول السنوات مباشرة في التسلسل الزمني حتى تظهر وتُربط بالشيكات في «إدارة الشيكات»
    (client.extraStandardItems||[]).forEach((row,i)=>{
      const amt = (client.remaining||0) * ((parseFloat(row.percent)||0)/100);
      const due = addMonthsAnchored(startDate, monthIndex);
      monthIndex++;
      installments.push({
        id: client.id+"_si"+(row.id||i), seq: seq++, type:"بند إضافي",
        label: row.label || `بند إضافي ${i+1}`,
        year:null, month:null, amount: amt,
        dueDate: toISODateLocal(due)
      });
    });
  }
  ...
  installments.forEach(inst=>{
    ...
    if(o){
      if(o.amount!=null && o.amount!=="") inst.amount = parseFloat(o.amount)||0;
      if(o.dueDate) inst.dueDate = o.dueDate;
      if(o.label!=null && o.label!=="") inst.label = o.label;
      inst.chequeNumberOverride = o.chequeNumberOverride || "";
      inst.bankOverride = o.bankOverride || "";
      inst.edited = true;
    }
  });
  return installments;
...
function renderChequesScreen(){
  ...
  // CFO11 القديم (isLimitedChequesRole): جدول مختصر (بيان/تاريخ استحقاق/رقم شيك فقط) — لم يعد مستخدَمًا لأي كود حاليًا.
  // CFO11 (isSelectRegisterNoPrintRole، «مسؤول»): يرى الجدول الكامل بكل تفاصيله، ويقدر يحدد الدفعة ويسجّل
  //   رقم الشيك واسم البنك، لكن بدون طباعة أو تعديل أو حذف.
  // CMO11 (isViewOnlyChequesRole): يرى الجدول الكامل بكل أعمدته، للعرض فقط بدون أي أداة تفاعل (تحديد/تسجيل/تعديل/حذف/طباعة).
  const chqViewOnly = isViewOnlyChequesRole();
  const chqSelectRegisterNoPrint = isSelectRegisterNoPrintRole();
  const chqNoActions = isLimitedChequesRole();
  const chqNoSelect = chqViewOnly;
  const chqReadOnlyRow = !isAdmin(); // التعديل والحذف وطباعة الإيصال في شاشة الشيكات حصرًا للأدمن فقط
    ...
    <div class="table-wrap">
      <table id="planTable">
        <thead><tr>
          ...
          ${chqNoActions ? `
          <th>البيان</th><th>تاريخ الاستحقاق</th><th>رقم الشيك</th>
          ` : `
          <th>م</th><th>البيان</th><th>نوع الدفعة</th><th>تاريخ الاستحقاق</th>
          <th>القيمة المستحقة</th><th>المسدد</th><th>رقم الشيك</th><th>الحالة</th>${chqReadOnlyRow ? "" : `<th class="no-print">تعديل</th>`}
          `}
        </tr></thead>
        <tbody>
            ...
            const chqCell = linkedCheques.length
              ? linkedCheques.map(chq=>`
                  <div style="display:flex;align-items:center;gap:6px;justify-content:flex-end;">
                    <span>${esc(chq.chequeNumber)}${chq.bank?` — ${esc(chq.bank)}`:""} ${chequeStatusBadge(chq)}</span>
                    ${chqReadOnlyRow ? "" : `
              ...
              : ((inst.chequeNumberOverride||inst.bankOverride)
                  ? `<span>${esc(inst.chequeNumberOverride||"—")}${inst.bankOverride?` — ${esc(inst.bankOverride)}`:""} <span class="muted" title="بيانات مُدخلة يدويًا، دون شيك مسجَّل فعليًا">✎</span></span>`
                  : `<span class="muted">—</span>`);
            return chqNoActions ? `<tr>
              ...
              ${chqReadOnlyRow ? "" : `<td class="no-print"><button class="btn btn-ghost btn-sm" data-edit-inst="${inst.id}">تعديل</button></td>`}
            </tr>`;
          }).join("")}
        </tbody>
      </table>
  ...
  <div class="card">
    ...
    <div class="row3">
      ...
      <div class="field" style="${chqNoActions ? "display:none;" : ""}">
        <label>تاريخ استحقاق الشيك</label>
        <input id="chkDate" type="date" readonly style="background:#f1ede2;">
        <div class="import-hint">تلقائي — يؤخذ من تاريخ استحقاق الدفعة المحددة أدناه.</div>
      </div>
    </div>
    <div class="row" style="${chqNoActions ? "display:none;" : ""}">
      <div class="field">
        <label>تاريخ استلام الشيك</label>
...
let chqReportFilterState = { status:"all", q:"" };
...
function renderClientsScreen(){
  ...
  if(addOnly){
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;">
        <h2 style="margin:0;">عميل جديد</h2>
  ...
  if(state.clients.length===0){
    ...
    html += `<div class="table-wrap"><table id="clientsListTable"><thead><tr>
      <th>الكود</th><th>اسم العميل</th><th>الوحدة</th><th>سعر الوحدة</th><th>تاريخ التعاقد</th><th></th>
    </tr></thead><tbody>
      ${state.clients.map(c=>`
        <tr>
...
function renderClientForm(){
  ...
  // بنود إضافية (بيان + نسبة) فوق جدول السنوات — للأدمن فقط إضافة/حذف/ترتيب، والموظف يشوف بس
  const adminCanEditItems = isAdmin();
  let extraStandardRows = "";
  (f.extraStandardItems||[]).forEach((row,i)=>{
    extraStandardRows += `
      <tr data-si-row="${row.id}">
        <td class="num muted">${i+1}</td>
        <td>${adminCanEditItems
          ? `<input class="siLabelInput" data-id="${row.id}" value="${esc(row.label)}" placeholder="بيان البند">`
          : `<span>${esc(row.label||"—")}</span>`}</td>
        <td>${adminCanEditItems
          ? `<input type="number" step="0.01" class="siPercentInput" data-id="${row.id}" value="${esc(row.percent??"")}" placeholder="0" style="max-width:100px;">`
          : `<span>${esc(row.percent??"0")}%</span>`}</td>
        <td class="num"><span id="siVal_${row.id}">0</span> ر.ع</td>
        ${adminCanEditItems ? `
        <td class="no-print" style="white-space:nowrap;">
          <button type="button" class="btn btn-ghost btn-sm" data-si-up="${row.id}" title="نقل لأعلى">↑</button>
          <button type="button" class="btn btn-ghost btn-sm" data-si-down="${row.id}" title="نقل لأسفل">↓</button>
          <button type="button" class="btn btn-danger btn-sm" data-si-del="${row.id}">حذف</button>
        </td>` : ``}
      </tr>`;
  });
      ...
      <div class="year-block">
        ...
        <div class="phase-grid">
          <div class="field" style="margin-bottom:0;">
            ...
            <input type="number" step="0.001" class="phase1Input" data-idx="${i}" value="${esc(yp.phase1??"")}" placeholder="اتركه 0 للحساب التلقائي">
            <div class="import-hint" id="phase1Hint_${i}"></div>
          </div>
          <div class="field" style="margin-bottom:0;">
            <label>المرحلة الثانية (تاني 3 أشهر) — قيمة القسط</label>
            <input type="number" step="0.001" class="phase2Input" data-idx="${i}" value="${esc(yp.phase2??"")}" placeholder="اتركه 0 للحساب التلقائي">
            <div class="import-hint" id="phase2Hint_${i}"></div>
          </div>
          <div class="field" style="margin-bottom:0;">
            <label>المرحلة الثالثة (آخر 5 أشهر) — قيمة القسط</label>
            <input type="number" step="0.001" class="phase3Input" data-idx="${i}" value="${esc(yp.phase3??"")}" placeholder="اتركه 0 للحساب التلقائي">
  ...
  <div class="card" id="clientFormCard">
      ...
      <div class="row3">
        ...
        <div class="field">
          ...
          <div class="phone-input-group">
            <span class="phone-cc">+968</span>
            <input id="fPhone" value="${esc(stripCountryCode(f.phone))}" placeholder="9XXX XXXX">
          </div>
        </div>
      </div>
      <div class="row3">
    ...
    <div class="form-section emphasis-brass">
      ...
      <div class="field">
        ...
        <input id="fUnitPrice" type="number" step="0.001" value="${esc(f.unitPrice)}" placeholder="0.00">
      </div>
      <div class="row">
        <div class="field">
    ...
    <div class="form-section emphasis-navy">
      <div class="form-section-title"><span class="num">4.1</span> بنود إضافية على الأقساط الاعتيادية</div>
      <p class="hint" style="margin-top:-8px;">${adminCanEditItems
        ? "بنود اختيارية (بيان + نسبة من المتبقي المقسط) تُضاف فوق جدول توزيع السنوات أعلاه — الإضافة والحذف وإعادة الترتيب متاحة للأدمن فقط."
        : "بنود إضافية اعتمدها الأدمن على خطة السداد. العرض فقط — الإضافة والتعديل والحذف من صلاحية الأدمن."}</p>
      ${extraStandardRows ? `
      <div class="table-wrap" style="margin-top:10px;background:#fff;">
        <table>
          <thead><tr><th>م</th><th>البيان</th><th>النسبة %</th><th>القيمة (تلقائي)</th>${adminCanEditItems ? `<th class="no-print"></th>` : ``}</tr></thead>
          <tbody id="siRowsBody">${extraStandardRows}</tbody>
        </table>
      </div>` : (adminCanEditItems ? `` : `<div class="empty" style="padding:14px;">لا توجد بنود إضافية على هذه الخطة.</div>`)}
      ${adminCanEditItems ? `
      <div style="margin-top:10px;">
        <button type="button" class="btn btn-ghost btn-sm" id="btnSiAddRow">+ إضافة بند</button>
      </div>` : ``}
      <div class="totals-row" style="margin-top:10px;">
        <span>إجمالي البنود الإضافية — نسبة <span id="siTotalPct">0%</span></span>
        <span id="siTotalVal">0 ر.ع</span>
      </div>
    </div>
...
/* True when a cheque marked "collected" was only partially cashed (collectedAmount < face value). */
function isPartialCollection(chq){
  const face = chq.amount||0;
  const collected = (chq.collectedAmount!=null ? chq.collectedAmount : face);
  return chq.status==="collected" && face>0.5 && collected < face-0.5;
}

/* Derive the filter key for a cheque row in the cheques report:
   collected / partial (تحصيل جزئي) / bounced / late (متأخرة) / waiting (في انتظار التحصيل، خلال 7 أيام) / upcoming (لم يحين موعدها) */
function chequeReportStatusKey(chq){
  const status = chq.status || "pending";
  if(status==="collected") return isPartialCollection(chq) ? "partial" : "collected";
  if(status==="bounced") return "bounced";
  return pendingChequeUrgency(chq.chequeDate); // "late" | "waiting" | "upcoming"
}

/* Remove a leading Oman country code (+968 / 968 / 00968) from a stored phone
   value so only the local number is shown inside the phone input field. */
function stripCountryCode(phone){
  let p = String(phone||"").trim();
  p = p.replace(/^(\+|00)?968[\s-]*/,"");
  return p;
}
/* Re-attach the fixed +968 country code to whatever local number the user typed. */
function withCountryCode(local){
  const clean = stripCountryCode(local).trim();
  if(!clean) return "";
  return "+968 " + clean;
}
function whatsappDigits(phone){
  ...
  p = p.replace(/^00/,"");
  p = p.replace(/^\+/,"");
  if(p.length===8) p = "968"+p; // bare Omani local number -> add country code
  return p;
}

/* Build a polished, CFO-toned Arabic WhatsApp message for a cheque row, tailored to its
   collection status (late / waiting / upcoming / collected / bounced). Mentions the client
   by name and speaks on behalf of the company's financial management. */
function buildWhatsAppMessage(chq, cl){
  const name = (cl?.name||"عميلنا الفاضل").trim();
  const amount = `${fmt(chq.amount)} ر.ع`;
  const chequeNo = chq.chequeNumber || "—";
  const bank = chq.bank || "—";
  const dueDate = fmtDate(chq.chequeDate);
  const statusKey = chequeReportStatusKey(chq);
  const signature = "مع خالص التقدير،\nالإدارة المالية";

  let body;
  if(statusKey === "collected"){
    body = `نتقدم لسعادتكم بجزيل الشكر والتقدير على التزامكم بالسداد.\n\nنُفيدكم بأنه قد تم تحصيل الشيك رقم *${chequeNo}* الصادر عن بنك ${bank} بقيمة *${amount}* بنجاح، وقد تم قيده في سجلاتنا المالية أصولاً.\n\nنعتز بثقتكم الغالية ونتطلع لاستمرار هذا التعاون الطيب.`;
  } else if(statusKey === "partial"){
    const face = chq.amount||0;
    const collected = (chq.collectedAmount!=null ? chq.collectedAmount : face);
    const remaining = Math.max(0, face-collected);
    body = `نتقدم لسعادتكم بالشكر على ما تم سداده حتى الآن.\n\nنُفيدكم بأنه قد تم تحصيل مبلغ *${fmt(collected)} ر.ع* فقط من قيمة الشيك رقم *${chequeNo}* الصادر عن بنك ${bank}، والبالغة قيمته الاسمية *${fmt(face)} ر.ع*، وقد تم قيد هذا المبلغ في سجلاتنا المالية أصولاً.\n\nويتبقى بذمتكم مبلغ *${fmt(remaining)} ر.ع* من قيمة هذا الشيك، ونأمل التكرم بمتابعة سداده في أقرب وقت ممكن.`;
  } else if(statusKey === "bounced"){
    body = `نأمل الاطلاع على ما يلي بما يستحقه من اهتمام عاجل.\n\nتم إشعارنا من البنك المسحوب عليه بارتداد الشيك رقم *${chequeNo}* الصادر عن بنك ${bank} بقيمة *${amount}*، ولم يتم تحصيله حتى تاريخه.\n\nنرجو التكرم بالتواصل مع الإدارة المالية في أقرب وقت ممكن لتسوية هذا الأمر وتفادي أي إجراءات تعاقدية أخرى.`;
  } else if(statusKey === "late"){
    body = `نأمل الاطلاع على ما يلي.\n\nنود تذكيركم بأن الشيك رقم *${chequeNo}* الصادر عن بنك ${bank} بقيمة *${amount}* والمستحق بتاريخ ${dueDate} لا يزال قيد الانتظار ولم يُحصَّل حتى الآن.\n\nنرجو التكرم بمتابعة رصيد الحساب البنكي المسحوب عليه الشيك لضمان تحصيله في أقرب فرصة، ونشكر تعاونكم المستمر معنا.`;
  } else if(statusKey === "waiting"){
    body = `تحية طيبة وبعد،\n\nنود إحاطتكم علماً بأن موعد استحقاق الشيك رقم *${chequeNo}* الصادر عن بنك ${bank} بقيمة *${amount}* يقترب، وذلك بتاريخ ${dueDate}.\n\nنرجو التكرم بالتأكد من توفر الرصيد الكافي في الحساب البنكي المعني لضمان تحصيله دون أي تعثر.`;
  } else {
    body = `تحية طيبة وبعد،\n\nنُفيدكم بأنه قد تم استلام الشيك رقم *${chequeNo}* الصادر عن بنك ${bank} بقيمة *${amount}*، وموعد استحقاقه بتاريخ ${dueDate}.\n\nسيقوم قسمنا المالي بمتابعة تحصيله في موعده، ونشكر لكم دقتكم والتزامكم.`;
  }

  return `عميلنا الفاضل/ة ${name}،\n\n${body}\n\n${signature}`;
}

/* ============================= SCREEN: REPORTS ============================= */
function renderChequesReport(){
  const allRows = state.cheques.slice().sort((a,b)=>a.seq-b.seq).map(chq=>{
    const cl = state.clients.find(c=>c.id===chq.clientId);
    return {chq, cl};
  });
  ...
  const q = chqReportFilterState.q.trim().toLowerCase();
  let rows = allRows;
  if(chqReportFilterState.status!=="all"){
    rows = rows.filter(r=>chequeReportStatusKey(r.chq)===chqReportFilterState.status);
  }
  if(q){
    rows = rows.filter(r=>{
      if((r.chq.chequeNumber||"").toLowerCase().includes(q)) return true;
      if((r.cl?.code||"").toLowerCase().includes(q)) return true;
      if((r.cl?.name||"").toLowerCase().includes(q)) return true;
      if((r.chq.bank||"").toLowerCase().includes(q)) return true;
      if((r.cl?.phone||"").toLowerCase().includes(q)) return true;
      return false;
    });
  }
  ...
  html += `<div class="toolbar">
    <div class="field grow" style="margin-bottom:0;">
      <label>بحث (رقم الشيك / كود العميل / اسم العميل / رقم الهاتف / البنك)</label>
      <input id="chqReportSearch" value="${esc(chqReportFilterState.q)}" placeholder="اكتب للبحث...">
    </div>
    <div class="field" style="margin-bottom:0;min-width:190px;">
      <label>حالة التحصيل</label>
      <select id="chqReportStatus">
        <option value="all" ${chqReportFilterState.status==="all"?"selected":""}>الكل</option>
        <option value="waiting" ${chqReportFilterState.status==="waiting"?"selected":""}>في انتظار التحصيل</option>
        <option value="late" ${chqReportFilterState.status==="late"?"selected":""}>متأخرة</option>
        <option value="upcoming" ${chqReportFilterState.status==="upcoming"?"selected":""}>لم يحين موعدها</option>
        <option value="collected" ${chqReportFilterState.status==="collected"?"selected":""}>تم التحصيل</option>
        <option value="partial" ${chqReportFilterState.status==="partial"?"selected":""}>تحصيل جزئي</option>
        <option value="bounced" ${chqReportFilterState.status==="bounced"?"selected":""}>مرتد</option>
      </select>
    </div>
  </div>`;
  ...
  html += `<div class="table-wrap"><table id="chqReportTable"><thead><tr>
    <th>م</th><th>كود العميل</th><th>اسم العميل</th><th>رقم هاتف العميل</th><th>رقم الشيك</th><th>البنك</th>
    <th>نوع الدفعة</th><th>تاريخ الاستلام</th><th>تاريخ استحقاق الشيك</th><th>القيمة</th><th>حالة التحصيل</th><th>تاريخ التحصيل</th><th>رسالة واتساب</th><th class="no-print">إرسال</th><th class="no-print perm-admin-only">إيصال</th>
  </tr></thead><tbody>
    ${rows.map((r,i)=>{
      ...
      const waMsg = buildWhatsAppMessage(r.chq, r.cl);
      const waDigits = whatsappDigits(r.cl?.phone);
      ...
      <tr>
        ...
        <td class="num" style="font-family:monospace;">${esc(r.cl?.code||"—")}</td>
        <td>${esc(r.cl?.name||"عميل محذوف")}</td>
        <td class="num" style="direction:ltr;text-align:right;">${esc(r.cl?.phone||"—")}</td>
        <td class="num">${esc(r.chq.chequeNumber)}</td>
        <td>${esc(r.chq.bank||"—")}</td>
        ...
        <td class="num">${fmt(r.chq.amount)}</td>
        <td>${chequeStatusBadge(r.chq)}</td>
        <td class="num">${r.chq.status==="collected" ? fmtDate(r.chq.collectedDate) : "—"}</td>
        <td style="white-space:pre-line;min-width:260px;font-size:12.5px;">${esc(waMsg)}</td>
        <td class="no-print">${waLink ? `<a class="btn btn-navy btn-sm" href="${waLink}" target="_blank" rel="noopener" style="text-decoration:none;">واتساب</a>` : `<span class="muted">لا يوجد هاتف</span>`}</td>
        <td class="no-print perm-admin-only"><button class="btn btn-ghost btn-sm" data-print-any-receipt="${r.chq.id}" title="طباعة أي إيصال متاح لهذا الشيك">🖨️ طباعة</button></td>
      </tr>
    `;}).join("")}
  </tbody>
  <tfoot><tr style="font-weight:700;"><td colspan="9">الإجمالي (${rows.length} شيك)</td><td class="num">${fmt(totalAmt)}</td><td></td><td></td><td></td><td class="no-print"></td><td class="no-print perm-admin-only"></td></tr></tfoot>
  </table></div>
...
function openEditInstallmentModal(instId){
  ...
  const linkedCheques = state.cheques.filter(chq=>(chq.allocations||[]).some(a=>a.installmentId===instId));
  const singleChq = linkedCheques.length===1 ? linkedCheques[0] : null;

  let chqFieldsHtml = "";
  if(linkedCheques.length>1){
    chqFieldsHtml = `<p class="hint">هذه الدفعة مرتبطة بأكثر من شيك، لذا يجب تعديل رقم الشيك/البنك لكل شيك على حدة من عمود «رقم الشيك» في جدول خطة السداد.</p>`;
  } else {
    const chqNumberVal = singleChq ? (singleChq.chequeNumber||"") : (inst.chequeNumberOverride||"");
    const bankVal = singleChq ? (singleChq.bank||"") : (inst.bankOverride||"");
    chqFieldsHtml = `
      <div class="field">
        <label>رقم الشيك</label>
        <input id="editInstChqNumber" value="${esc(chqNumberVal)}" placeholder="رقم الشيك">
      </div>
      <div class="field">
        <label>اسم البنك</label>
        ${bankSelectHtml("editInstBank", bankVal)}
      </div>
      ${singleChq ? "" : `<p class="hint">لا يوجد شيك فعلي مسجَّل لهذه الدفعة — إدخال رقم الشيك/البنك هنا للعرض فقط، ولا يُنشئ سجل شيك حقيقي.</p>`}
    `;
  }
  ...
  <div class="modal-bg" id="editInstBg">
    <div class="modal">
      ...
      <div class="field">
        <label>البيان</label>
        <input id="editInstLabel" value="${esc(inst.label)}">
      </div>
      <div class="field">
  ...
  if(linkedCheques.length<=1) bindBankSelect("editInstBank");
  document.getElementById("editInstSave").addEventListener("click", ()=>{
    ...
    const label = (document.getElementById("editInstLabel").value||"").trim();
    if(isNaN(amount) || amount<0){ toast("أدخل قيمة صحيحة"); return; }
    if(!label){ toast("أدخل البيان"); return; }
    if(!c.planOverrides) c.planOverrides = {};
    const override = { amount, dueDate: dueDate||null, label };
    if(linkedCheques.length===1){
      // Persist directly onto the actual linked cheque record.
      singleChq.chequeNumber = (document.getElementById("editInstChqNumber").value||"").trim();
      singleChq.bank = getBankValue("editInstBank");
    } else if(linkedCheques.length===0){
      override.chequeNumberOverride = (document.getElementById("editInstChqNumber").value||"").trim();
      override.bankOverride = getBankValue("editInstBank");
    }
    c.planOverrides[instId] = override;
    saveState();
...
function updateChequeAmount(){
  ...
  amtInput.value = total.toFixed(3);
...
function saveCheque(){
  ...
  chequeSearchState.selectedInstallments = {};
  // CFO11 («مسؤول» بصلاحية selectRegisterNoPrint): غير مصرح له بالطباعة، فلا نفتح له نافذة الإيصال بعد الحفظ
  if(!isSelectRegisterNoPrintRole()){
...
function bindClientsEvents(){
  ...
  document.querySelectorAll("[data-edit-client]").forEach(btn=>{
    btn.addEventListener("click", ()=>{
      ...
      clientForm = {
        ...
        extraStandardItems: (c.extraStandardItems||[]).map(r=>({ id:r.id||uid("si"), label:r.label, percent:r.percent }))
      };
  ...
  // إضافة/حذف/ترتيب بنود جدول الاستشاري: للأدمن فقط (الموظف يشوف الجدول بدون هذه الأزرار أصلًا،
  // لكن نتحقق من الصلاحية هنا أيضًا كخط دفاع ثانٍ)
  ...
  // إضافة/حذف/ترتيب البنود الإضافية على الأقساط الاعتيادية: للأدمن فقط
  const siAddBtn = document.getElementById("btnSiAddRow");
  if(siAddBtn && isAdmin()){
    siAddBtn.addEventListener("click", ()=>{
      syncFormFromInputs();
      if(!Array.isArray(clientForm.extraStandardItems)) clientForm.extraStandardItems = [];
      clientForm.extraStandardItems.push({ id: uid("si"), label:"", percent:"" });
      render();
    });
  }
  if(isAdmin()){
    document.querySelectorAll("[data-si-del]").forEach(btn=>{
      btn.addEventListener("click", ()=>{
        syncFormFromInputs();
        clientForm.extraStandardItems = (clientForm.extraStandardItems||[]).filter(r=>r.id!==btn.dataset.siDel);
        render();
      });
    });
    document.querySelectorAll("[data-si-up]").forEach(btn=>{
      btn.addEventListener("click", ()=>{
        syncFormFromInputs();
        const arr = clientForm.extraStandardItems||[];
        const idx = arr.findIndex(r=>r.id===btn.dataset.siUp);
        if(idx>0){ [arr[idx-1],arr[idx]] = [arr[idx],arr[idx-1]]; render(); }
      });
    });
    document.querySelectorAll("[data-si-down]").forEach(btn=>{
      btn.addEventListener("click", ()=>{
        syncFormFromInputs();
        const arr = clientForm.extraStandardItems||[];
        const idx = arr.findIndex(r=>r.id===btn.dataset.siDown);
        if(idx>=0 && idx<arr.length-1){ [arr[idx+1],arr[idx]] = [arr[idx],arr[idx+1]]; render(); }
      });
    });
  }
...
function recalcClientForm(){
  ...
  // extra standard items (بنود إضافية على الأقساط الاعتيادية) totals — read from
  // editable inputs when present (admin), or from static spans when read-only (employee)
  let totalSiPct=0, totalSiVal=0;
  document.querySelectorAll(".siPercentInput").forEach(inp=>{
    const pct = parseFloat(inp.value)||0;
    const val = remainVal*pct/100;
    totalSiPct += pct; totalSiVal += val;
    setText("siVal_"+inp.dataset.id, fmt(val));
  });
  document.querySelectorAll("#siRowsBody tr[data-si-row]").forEach(tr=>{
    if(tr.querySelector(".siPercentInput")) return; // already counted above (admin/editable)
    const id = tr.dataset.siRow;
    const pctText = tr.querySelector("td:nth-child(3) span")?.textContent || "0";
    const pct = parseFloat(pctText)||0;
    const val = remainVal*pct/100;
    totalSiPct += pct; totalSiVal += val;
    setText("siVal_"+id, fmt(val));
  });
  setText("siTotalPct", totalSiPct.toFixed(2)+"%");
  setText("siTotalVal", fmt(totalSiVal)+" ر.ع");
...
function syncFormFromInputs(){
  ...
  clientForm.phone = withCountryCode(g("fPhone"));
  ...
  if(clientForm.extraStandardItems){
    document.querySelectorAll(".siLabelInput").forEach(inp=>{
      const row = clientForm.extraStandardItems.find(r=>r.id===inp.dataset.id);
      if(row) row.label = inp.value;
    });
    document.querySelectorAll(".siPercentInput").forEach(inp=>{
      const row = clientForm.extraStandardItems.find(r=>r.id===inp.dataset.id);
...
function saveClientForm(){
  ...
  if(installmentMode === "consultant"){
    ...
    // بنود إضافية (بيان + نسبة) فوق جدول السنوات — إضافة/حذف/ترتيب للأدمن فقط
    const extraRows = (f.extraStandardItems||[]).filter(r=>(r.label||"").trim());
    payload.extraStandardItems = extraRows.map(r=>({ id:r.id||uid("si"), label:r.label.trim(), percent: parseFloat(r.percent)||0 }));
  }
...
function bindChequesReportEvents(){
  ...
  document.querySelectorAll(".perm-admin-only").forEach(el=>{
    if(!isAdmin) el.style.display = "none";
  });
  if(isAdmin){
    document.querySelectorAll("[data-print-any-receipt]").forEach(btn=>{
      btn.addEventListener("click", ()=>printAnyReceiptFor(btn.dataset.printAnyReceipt));
    });
  }
  const search = document.getElementById("chqReportSearch");
  if(search){
    search.addEventListener("input", ()=>{
      chqReportFilterState.q = search.value;
      render();
      document.getElementById("chqReportSearch")?.focus();
    });
  }
  const status = document.getElementById("chqReportStatus");
  if(status){
    status.addEventListener("change", ()=>{
      chqReportFilterState.status = status.value;
      render();
    });
  }
}
...
/* Admin-only: print whichever receipt applies to a cheque row in the cheques report —
   the official collection receipt (إيصال تحصيل) if any collection record exists for it
   (even for a partially-collected cheque), otherwise the plain receipt of acceptance
   (محضر استلام الشيك) that was issued when the cheque was received. */
function printAnyReceiptFor(chequeId){
  const chq = state.cheques.find(c=>c.id===chequeId);
  if(!chq){ toast("تعذر العثور على الشيك"); return; }
  const cl = state.clients.find(c=>c.id===chq.clientId);
  if(!cl){ toast("بيانات العميل غير متوفرة لهذا الشيك"); return; }
...
function openReceipt(cheque, client, instItems, isReprint){
  ...
  const yearsHtml = isConsultantMode
    ...
    : yearPlans.map((yp,idx)=>`
        ...
        </tr>`).join("") + (client.extraStandardItems||[]).map(row=>`
        <tr>
          <td>${esc(row.label)}</td>
          <td class="num">${fmt((client.remaining||0)*((parseFloat(row.percent)||0)/100))}</td>
        </tr>`).join("");
  const totalInstallments = isConsultantMode
    ...
    : yearPlans.reduce((s,yp)=>s+(yp.amount||0),0) + (client.extraStandardItems||[]).reduce((s,row)=>s+(client.remaining||0)*((parseFloat(row.percent)||0)/100),0);
  ...
  const agreedPaymentsCount = isConsultantMode
    ...
    : yearPlans.length + (client.extraStandardItems||[]).length;
...
function showReceiptModal(isReprint){
  const root = document.getElementById("modalRoot");
  if(isLimitedChequesRole()){ root.innerHTML=""; return; }
...
function tableToAOA(tableId){
  ...
  table.querySelectorAll("tr").forEach(tr=>{
    ...
    tr.querySelectorAll("th,td").forEach(cell=>{
      if(cell.classList.contains("no-print")) return; // skip action/UI-only columns (buttons, checkboxes)
...
/* ============================= INIT ============================= */
initAuth();
/* ملحوظة: تسجيل الدخول وعرض الشاشة الأولى يتمّان الآن داخل onAuthStateChanged
   بعد التحقق من Firebase وجلب البيانات المشتركة من الخادم (انظر initAuth). */

})();
</script>

<!-- Optional: SheetJS for proper .xlsx export. Falls back to CSV automatically if offline. -->
